...
<span id="bufferBar" style="background-color: red; width: 0px; height: 10px; position: absolute"></span></div>
<form action="" method="get">
  <button type="submit" value="step2" formmethod="post" formaction="">NEXT</button>
</form>
<BR><BR><BR>
ADVANCED OPTIONS
</TD>
...
<p>
<BR>
This text is not part of the mockup but to comment things. To make it simple, no more info but move the mouse. when green color appears also APPEARS NEXT BUTTON. ADVANCED OPTIONS go to the actual menu of RS of create identities etc.
</p>
